...
export abstract class ModelServiceBase<TModel>
{
  ...
  { 
    return this.withAuthentication(
      (headers) => this.apiService.post(this.path, parameter, headers)); 
  }
  ...
  { 
    return this.withAuthentication(
      (headers) => this.apiService.put(this.path, parameter, headers)); 
  }
  ...
  { 
    return this.withAuthentication(
      (headers) => this.apiService.delete(this.path + "/" + id, headers)); 
  }
  ...
  retrieve(parameters: [{ name: string, value: Object }] = null): Observable<ApiReply<TModel[]>> 
  {
    ...
    return this.withAuthentication((headers) => this.apiService.get<TModel[]>(path, headers));
  }
  ...
  { 
    return this.withAuthentication<TModel>(
      (options) => this.apiService.get<TModel>(this.path + "/" + id, options)); 
  }
